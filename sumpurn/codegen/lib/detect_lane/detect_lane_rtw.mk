...
## Generated on : Mon Jan 22 08:54:08 2018
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:\Sumpurn\Projects\GPU\gpucoderdemo_lane_detection
ARCH                      = win64
...
INCLUDES_BUILDINFO = $(START_DIR)\sumpurn\codegen\lib\detect_lane;$(START_DIR);$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\rtw\c\ert;C:\Users\KRISHN~1\DOWNLO~1\CUDNN-~1.1\cuda\include
...
SRCS = $(START_DIR)\sumpurn\codegen\lib\detect_lane\detect_lane_initialize.cu $(START_DIR)\sumpurn\codegen\lib\detect_lane\detect_lane_terminate.cu $(START_DIR)\sumpurn\codegen\lib\detect_lane\detect_lane.cu $(START_DIR)\sumpurn\codegen\lib\detect_lane\DeepLearningNetwork.cu $(START_DIR)\sumpurn\codegen\lib\detect_lane\rt_nonfinite.cu $(START_DIR)\sumpurn\codegen\lib\detect_lane\rtGetNaN.cu $(START_DIR)\sumpurn\codegen\lib\detect_lane\rtGetInf.cu $(START_DIR)\sumpurn\codegen\lib\detect_lane\cnn_api.cu
...
{$(START_DIR)\sumpurn\codegen\lib\detect_lane}.cu.obj :
	$(CC) $(CFLAGS) -o  "$@" "$<"


{$(START_DIR)\sumpurn\codegen\lib\detect_lane}.c.obj :
	$(CC) $(CFLAGS) -o  "$@" "$<"
...
{$(START_DIR)\sumpurn\codegen\lib\detect_lane}.cpp.obj :
	$(CPP) $(CPPFLAGS) -o  "$@" "$<"
