...
// CUDA/C/C++ source code generated on  : 22-Jan-2018 08:53:55
//
...
void c_lanenet::setup()
{
  ...
  this->layers[0]->loadAvg(
    ".\\sumpurn\\codegen\\lib\\detect_lane\\cnn_lanenet_avg");
  this->layers[1]->createConvLayer(this->layers[0], 11, 11, 3, 96, 4, 4, 0, 0, 1);
  this->layers[1]->loadWeights(
    ".\\sumpurn\\codegen\\lib\\detect_lane\\cnn_lanenet_conv1_w");
  this->layers[1]->loadBias(
    ".\\sumpurn\\codegen\\lib\\detect_lane\\cnn_lanenet_conv1_b");
  ...
  this->layers[5]->loadWeights(
    ".\\sumpurn\\codegen\\lib\\detect_lane\\cnn_lanenet_conv2_w");
  this->layers[5]->loadBias(
    ".\\sumpurn\\codegen\\lib\\detect_lane\\cnn_lanenet_conv2_b");
  ...
  this->layers[9]->loadWeights(
    ".\\sumpurn\\codegen\\lib\\detect_lane\\cnn_lanenet_conv3_w");
  this->layers[9]->loadBias(
    ".\\sumpurn\\codegen\\lib\\detect_lane\\cnn_lanenet_conv3_b");
  ...
  this->layers[11]->loadWeights(
    ".\\sumpurn\\codegen\\lib\\detect_lane\\cnn_lanenet_conv4_w");
  this->layers[11]->loadBias(
    ".\\sumpurn\\codegen\\lib\\detect_lane\\cnn_lanenet_conv4_b");
  ...
  this->layers[13]->loadWeights(
    ".\\sumpurn\\codegen\\lib\\detect_lane\\cnn_lanenet_conv5_w");
  this->layers[13]->loadBias(
    ".\\sumpurn\\codegen\\lib\\detect_lane\\cnn_lanenet_conv5_b");
  ...
  this->layers[16]->loadWeights(
    ".\\sumpurn\\codegen\\lib\\detect_lane\\cnn_lanenet_fc6_w");
  this->layers[16]->loadBias(
    ".\\sumpurn\\codegen\\lib\\detect_lane\\cnn_lanenet_fc6_b");
  ...
  this->layers[19]->loadWeights(
    ".\\sumpurn\\codegen\\lib\\detect_lane\\cnn_lanenet_fcLane1_w");
  this->layers[19]->loadBias(
    ".\\sumpurn\\codegen\\lib\\detect_lane\\cnn_lanenet_fcLane1_b");
  this->layers[20]->createReLULayer(this->layers[19]);
  this->layers[21]->createFCLayer(this->layers[20], 16, 6);
  this->layers[21]->loadWeights(
    ".\\sumpurn\\codegen\\lib\\detect_lane\\cnn_lanenet_fcLane2_w");
  this->layers[21]->loadBias(
    ".\\sumpurn\\codegen\\lib\\detect_lane\\cnn_lanenet_fcLane2_b");
